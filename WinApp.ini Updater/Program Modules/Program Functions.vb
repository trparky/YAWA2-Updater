        ...
        Public Function ProcessFilePath(tempString As String, ByRef sectionsToRemove As Specialized.StringCollection, ByRef iniFileSection As IniFile.IniSection) As Boolean
            ...
            If directory.CaseInsensitiveContains("%ProgramFiles%") Then
                If Environment.Is64BitOperatingSystem Then
                    If Not IO.Directory.Exists(directory.Replace("%ProgramFiles%", Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), StringComparison.OrdinalIgnoreCase)) And Not IO.Directory.Exists(directory.Replace("%ProgramFiles%", Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86))) Then
                        If Not sectionsToRemove.Contains(iniFileSection.Name) Then
                            sectionsToRemove.Add(iniFileSection.Name)
                            Return True
                        Else : Return True
                    ...
                    End If
                Else
                    If Not IO.Directory.Exists(directory.Replace("%ProgramFiles%", Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), StringComparison.OrdinalIgnoreCase)) Then
                        If Not sectionsToRemove.Contains(iniFileSection.Name) Then
                            sectionsToRemove.Add(iniFileSection.Name)
                            Return True
                        Else : Return True
            ...
            ElseIf directory.CaseInsensitiveContains("%CommonProgramFiles%") Then
                If Environment.Is64BitOperatingSystem Then
                    If Not IO.Directory.Exists(directory.Replace("%CommonProgramFiles%", Environment.GetFolderPath(Environment.SpecialFolder.CommonProgramFiles), StringComparison.OrdinalIgnoreCase)) And Not IO.Directory.Exists(directory.Replace("%CommonProgramFiles%", Environment.GetFolderPath(Environment.SpecialFolder.CommonProgramFilesX86))) Then
                        If Not sectionsToRemove.Contains(iniFileSection.Name) Then
                            sectionsToRemove.Add(iniFileSection.Name)
                            Return True
                        Else : Return True
                    ...
                    End If
                Else
                    If Not IO.Directory.Exists(directory.Replace("%CommonProgramFiles%", Environment.GetFolderPath(Environment.SpecialFolder.CommonProgramFiles), StringComparison.OrdinalIgnoreCase)) Then
                        If Not sectionsToRemove.Contains(iniFileSection.Name) Then
                            sectionsToRemove.Add(iniFileSection.Name)
                            Return True
                        Else : Return True
        ...
        Public Function ProcessRegistryKey(tempString As String, ByRef sectionsToRemove As Specialized.StringCollection, ByRef iniFileSection As IniFile.IniSection) As Boolean
            Try
                ...
                If tempString.StartsWith("HKCU", StringComparison.OrdinalIgnoreCase) Then
                    tempString = tempString.Replace("HKCU\", "", StringComparison.OrdinalIgnoreCase)
                ...
                ElseIf tempString.StartsWith("HKLM", StringComparison.OrdinalIgnoreCase) Then
                    tempString = tempString.Replace("HKLM\", "", StringComparison.OrdinalIgnoreCase)
                ...
                ElseIf tempString.StartsWith("HKCR", StringComparison.OrdinalIgnoreCase) Then
                    tempString = tempString.Replace("HKCR\", "", StringComparison.OrdinalIgnoreCase)
                ...
                ElseIf tempString.StartsWith("HKU", StringComparison.OrdinalIgnoreCase) Then
                    tempString = tempString.Replace("HKU\", "", StringComparison.OrdinalIgnoreCase)
